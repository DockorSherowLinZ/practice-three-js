...
class OrbitControls extends EventDispatcher {
	...
	mouseButtons: { LEFT: _THREE.MOUSE; MIDDLE: _THREE.MOUSE; RIGHT: _THREE.MOUSE; };
	touches: { ONE: _THREE.TOUCH; TWO: _THREE.TOUCH; };
	target0: any;
	position0: any;
	zoom0: any;
	...
	constructor( object:any, domElement:any ) {
		...
		const panLeft = function () {
			...
			return function panLeft( distance: number, objectMatrix: _THREE.Matrix4 ) {
		...
		const panUp = function () {
			...
			return function panUp( distance: number, objectMatrix: _THREE.Matrix4 ) {
		...
		function updateMouseParameters( event: { clientX: number; clientY: number; } ) {
		...
		function handleMouseMoveRotate( event: { clientX: number; clientY: number; } ) {
		...
		function handleKeyDown( event: { code: any; ctrlKey: any; metaKey: any; shiftKey: any; preventDefault: () => void; } ) {
		...
		function trackPointer( event: { pointerId: string | number; pageX: any; pageY: any; } ) {
